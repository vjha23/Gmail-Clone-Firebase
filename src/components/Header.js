    ...
    return (
        <div className='header'>
            ...
            <div className='header__right'>
                ...
                <Avatar src={user ? user.photoURL : '#'} onClick={signOut} />
            </div>
        </div>
    )
}
